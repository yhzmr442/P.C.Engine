...
MUL_DATA_BANK		.equ	EDGE_FUNC_R_2_3_BANK + 1	; 8
...
;----------------------------
;CLEAR_SIZE_1KW CLEAR_SIZE_2KW
			IFDEF CLEAR_SIZE_1KW
CLEAR_BUFFER_COUNT	.equ	4
CLEAR_DMA_SIZE		.equ	$0400
				IFDEF DISPLAY_BOTTOM_144
CLEAR_DMA_COUNT		.equ	9
				ELSE
CLEAR_DMA_COUNT		.equ	12
				ENDIF
			ELSE
CLEAR_BUFFER_COUNT	.equ	6
CLEAR_DMA_SIZE		.equ	$0600
				IFDEF DISPLAY_BOTTOM_144
CLEAR_DMA_COUNT		.equ	6
				ELSE
CLEAR_DMA_COUNT		.equ	8
				ENDIF
			ENDIF
