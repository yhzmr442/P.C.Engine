...
POLYGON_FILL_FUNC_BANK	.equ	POLYGON_SUB_FUNC_BANK + 1	; 3

EDGE_FUNC_L_0_1_BANK	.equ	POLYGON_FILL_FUNC_BANK + 1	; 4

EDGE_FUNC_L_2_3_BANK	.equ	EDGE_FUNC_L_0_1_BANK + 1	; 5
EDGE_FUNC_R_0_1_BANK	.equ	EDGE_FUNC_L_2_3_BANK + 1	; 6
EDGE_FUNC_R_2_3_BANK	.equ	EDGE_FUNC_R_0_1_BANK + 1	; 7

CLEAR_FUNC_BANK		.equ	EDGE_FUNC_R_2_3_BANK + 1	; 8

MUL_DATA_BANK		.equ	CLEAR_FUNC_BANK + 1		; 9
DIV_DATA_BANK		.equ	MUL_DATA_BANK + 16	 	;25
ATAN_DATA_BANK		.equ	POLYGON_SUB_FUNC_BANK		; 2

POLYGON_FUNC_LAST_BANK	.equ	DIV_DATA_BANK + 8 - 1		;32
